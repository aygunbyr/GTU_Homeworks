...
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{"CamScanner 12-02-2020 11.57_1"}
	\caption{}
	\label{fig:camscanner-12-02-2020-11}
\end{figure}
...
\solution
\newline
$\{$1,2$\}$, $\{$1,3,4$\}$, $\{$2,3,4$\}$ are maximal elements.
\subproblem{b} Find the minimal elements.
\solution
\newline
$\{$1$\}$, $\{$2$\}$, $\{$4$\}$ are minimal elements.
...
\solution
\newline
$\{$2,4$\}$, $\{$2,3,4$\}$ are upper bounds of $\{\{$2$\}$, $\{$4$\}\}$.
\subproblem{e} Find the least upper bound of $\{\{$2$\}$, $\{$4$\}\}$, if it exists.
\solution
\newline
$\{$2,4$\}$ is the least upper bound of $\{\{$2$\}$, $\{$4$\}\}$.
\subproblem{f} Find all lower bounds of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$.
\solution
\newline
$\{$4$\}$, $\{$3,4$\}$ are lower bounds of 	$\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$.
\subproblem{h} Find the greatest lower bound of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$,
if it exists.
\solution
\newline
$\{$3,4$\}$ is the greatest lower bound of $\{\{$1, 3, 4$\}$, $\{$2, 3, 4$\}\}$.
\begin{figure}
	\centering
	\includegraphics[width=0.7\linewidth]{"CamScanner 12-04-2020 16.25"}
	\caption{}
	\label{fig:camscanner-12-04-2020-16}
\end{figure}
