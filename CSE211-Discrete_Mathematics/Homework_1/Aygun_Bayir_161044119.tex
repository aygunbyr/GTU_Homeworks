...
\newline
\textbf{Basis step:}\newline
Apply n=1 for the equation.\newline
\newline
3 + 3.5 = $\frac{3.(5^{1+1}-1)}{4}$\newline
18 = 18\newline
We prove that equation is true for n=1.\newline\newline
\textbf{Inductive step:}\newline
Apply n=k on the equation and accept that the equation is true for n=k.\newline
\newline
...
\newline
$\frac{3(5^{k+1} - 1)}{4}$ + $\frac {4 . 3 . 5^{k+1}}{4}$=$\frac{3(5^{k+2} - 1)}{4}$\newline
\newline
$\frac{3. 5^{k+1} - 3 + 12 . 5^{k+1}}{4}$ = $\frac{3(5^{k+2} - 1)}{4}$\newline
\newline
$\frac{15. 5^{k+1} - 3}{4}$ = $\frac{3.5.5^{k+1} - 3}{4}$\newline
\newline
$\frac{15. 5^{k+1} - 3}{4}$ = $\frac{15. 5^{k+1} - 3}{4}$\newline
\newline
...
int main(void) {
	int p=1, q=1, mux_switch, result;
	if(mux_switch==0) {
		result = p * q;
	}
	else if(mux_switch == 1) {
		result = p + (!q);
	}
